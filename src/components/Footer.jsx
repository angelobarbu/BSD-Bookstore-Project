    ...
    return (
        <footer className="flex flex-col sm:flex-row text-white bg-black p-4 pb-10">
            ...
            <div className="py-2 mr-5">
                <Link to="/about-us"><p className="text-sm text-gray-400 pb-1">About us</p></Link>
                <Link to="/forgot-password"><p className="text-sm text-gray-400 pb-1">Forgot password</p></Link>
                <Link to="/shipping-and-returns"><p className="text-sm text-gray-400 pb-1">Shipping and returns</p></Link>
